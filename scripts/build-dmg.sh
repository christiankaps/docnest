...
XCODEBUILD_ARGS=(
    ...
    "SWIFT_TREAT_WARNINGS_AS_ERRORS=${SWIFT_TREAT_WARNINGS_AS_ERRORS:-YES}"
    "GCC_TREAT_WARNINGS_AS_ERRORS=${GCC_TREAT_WARNINGS_AS_ERRORS:-YES}"
    "CLANG_TREAT_WARNINGS_AS_ERRORS=${CLANG_TREAT_WARNINGS_AS_ERRORS:-YES}"
)
